...
class nt_Calculator:
    ...
    def create_base_equality_dict():
        base_equality_dict = {
            ...
            "TS": 0,
            "TW": 0.5,
            "TB": 0.3333333333333333,
            "TD": 0.3333333333333333,
            ...
            "GD": 0.3333333333333333,
            "GH": 0,
            "GV": 0.3333333333333333,
            "GN": 0.25,
            "RA": 0.5,
            "RT": 0,
            "RC": 0,
            ...
            "WN": 0.25,
            "BA": 0,
            "BT": 0.3333333333333333,
            "BC": 0.3333333333333333,
            "BG": 0.3333333333333333,
            "BR": 0,
            "BK": 0,
            "BM": 0,
            "BS": 0,
            ...
            "DW": 0,
            "DB": 0,
            "DD": 0.3333333333333333,
            "DH": 0,
            "DV": 0,
            "DN": 0.25,
            "HA": 0.3333333333333333,
            "HT": 0.3333333333333333,
            "HC": 0.3333333333333333,
            "HG": 0,
            "HR": 0,
            "HK": 0,
            "HM": 0,
            ...
            "HB": 0,
            "HD": 0,
            "HH": 0.3333333333333333,
            "HV": 0,
            "HN": 0.25,
            "VA": 0.3333333333333333,
            "VT": 0,
            "VC": 0.3333333333333333,
            "VG": 0.3333333333333333,
            "VR": 0,
            "VK": 0,
            "VM": 0,
            "VS": 0,
    ...
    def calculate_PI(
        self, record1, record2, record1_ends=None, record2_ends=None, percent=True
    ):
        ...
        commen_ends = [
            max(record1_ends[0], record2_ends[0]),
            min(record1_ends[1], record2_ends[1]),
        ]
                ...
                if count == position_in_raw:
                    ...
                    if direction == -1:
                        position_in_alignment = (
                            len(sequence) - position_in_alignment + 1
                        )
                    break
    ...
    def calculate_sum_of_pairs_score(self, record_path, conservative=True):
        ...
        if Path(record_path).is_file():
            ...
            records = np.array(
                [list(str(record.seq).upper()) for record in record_iter]
            )
        else:
            records = record_path
    ...
    def get_kmer_similarity_matrix(self, records, k):
        ...
        for i in range(dim - 1):
            for j in range(i + 1, dim):
                similarity = self.calculate_kmer_similarity(
                    indexed_records[i], indexed_records[j]
                )
