...
from PySide6.QtWidgets import (
    ...
    QTabWidget, QGroupBox, QLabel, QLineEdit, QPlainTextEdit, QComboBox,
    QPushButton, QCheckBox, QRadioButton, QButtonGroup, QSpacerItem, QSizePolicy,
    QMenuBar, QMenu, QStatusBar, QLayout
)
...
class Ui_MainWindow(QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.out_path2.setPlaceholderText(QCoreApplication.translate("MainWindow", u"one folder to save the aligned fasta files, create a new one if does not exists", None))
        ...
        self.out_path3.setPlaceholderText(QCoreApplication.translate("MainWindow", u"one folder to save the trimmeded fasta files, create a new one if does not exists", None))
